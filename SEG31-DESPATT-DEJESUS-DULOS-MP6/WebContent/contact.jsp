...
<body>
	...
	<div class="navibar">
  		...
  		<a class="active" href="contact.jsp"><i class="fas fa-id-card"></i> Contact</a>
	...
	<div class="card">
			...
			<h3 class="card-title" style="padding-top: 10px;"><b>&nbsp;&nbsp;Contact Us</b></h1>
			<hr>
			<table>
				<tr>
					<table class="prodTable" align="center">
						<tr align="center">
							...
							<td>
								<p style="text-align: left;">&nbsp;You don't contact us <b>WE <span style="color: red;">FIND</span> YOU</b> </p>
							</td>
						</tr>
					</table>
				</tr>
