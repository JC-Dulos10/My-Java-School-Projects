...
<div class="container" style="width: 120%">
	...
	<div class="card">
		...
		<h3 class="card-title" style="padding-top: 10px;"><b>&nbsp;&nbsp;Search Results for <%=input %></b></h3>
		<hr>
		<div class="container">
			<div class="card">
				...
				try {
					//connecting to db
					searchInput = "%"+input+"%";
					PreparedStatement pstmnt = connection.prepareStatement(DBOperation.SEARCH_PHONE);
				    ...
				    if(rs.next() == false){
						...
						<form class="form-inline" action="index.jsp" method="post">
						  <div class="form-group row">
						    <div class="col-auto">
						   		<h5 style="color: red"><b>&nbsp;&nbsp;&nbsp;&nbsp;<%=input %> DOES NOT EXIST! PLEASE TRY AGAIN!</b></h3>
						    </div>
						    <div class="col-auto">
				    		...
				    		%>
						    	<div class="card" align="center">
						    		<div class="card-body">
									    ...
									    <img src="<%=rs.getString("Pic")%>" width="25%" height="25%">
									    <form action="search" method="post">
									    	<input type="hidden" class="form-control" id="input"  name="input" value='<%=phoneName %>'>
									    	<button class="btn btn-warning">Select Phone</button>
									    </form>
									</div>
						    	</div>
